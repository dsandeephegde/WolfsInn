...
class BuysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buy" do
    assert_difference('Buy.count') do
      post buys_url, params: { buy: { checkinId: @buy.checkinId, price: @buy.price, serviceId: @buy.serviceId } }
    end
  ...
  test "should update buy" do
    patch buy_url(@buy), params: { buy: { checkinId: @buy.checkinId, price: @buy.price, serviceId: @buy.serviceId } }
